...
export type Message = {
  ...
  created_at: string;
  read_at: string | null;
  sender: { full_name: string; foto_url: string | null } | { full_name: string; foto_url: string | null }[];
  receiver: { full_name: string; foto_url: string | null } | { full_name: string; foto_url: string | null }[];
};
