...
export default async function KoordinatorDashboardPage() {
  ...
  const actions = [
    { title: "Verifikasi Helper", detail: pendingHelperCount ? `${pendingHelperCount} pengajuan perlu ditinjau.` : "Tidak ada pengajuan baru di wilayah Anda.", count: pendingHelperCount, href: "/koordinator/antrean", icon: UserRoundCheck, tone: "info" },
