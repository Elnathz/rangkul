...
Instruksi ini berlaku untuk semua agent (OpenCode, Claude Code, Codex) yang bekerja di repo ini. File ini portable lintas-tool dan dibaca otomatis saat sesi mulai.
...
Project ini dikerjakan tim 3 orang. Peran saya di project adalah **backend** — agent ini fokus di area berikut:
